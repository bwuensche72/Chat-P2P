...
public class User {
    ...
    /**
     * Erstellung eines Benutzers des Chats, welcher gewisse Angaben geben soll, um teilnehmen zu können. Die Setzung
     * des Nicknamens erfolgt nach gewissen Vorgaben: Der Name soll kleiner als 20 Zeichen lang sein. Der Name soll
     * größer als ein Zeichen lang sein. Der Name soll aus Buchstaben und Zahlen bestehen, nur Leerschritte sind nicht
     * erlaubt.
     * 
    ...
    public User(String host, int port, String nickname) {
         ...
         * - Der Name soll aus Buchstaben und Zahlen bestehen, nur Leerschritte sind nicht erlaubt.
         */
